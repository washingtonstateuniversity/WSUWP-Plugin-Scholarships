...
class WSUWP_Scholarship_Settings {
	/**
	 * @var WSUWP_Scholarship_Settings
	 *
	 * @since 0.0.7
	 */
	...
	public static function get_instance() {
		if ( ! isset( self::$instance ) ) {
			self::$instance = new WSUWP_Scholarship_Settings();
	...
	public function add_settings_page() {
		add_submenu_page(
			'edit.php?post_type=' . WSUWP_Scholarship_Post_Type::$post_type_slug,
